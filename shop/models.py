...
class Bug(models.Model):
	bug_url = models.CharField('Адрес доставки', max_length = 300)
	bug_desc = models.CharField('Адрес доставки', max_length = 1000)
	bug_rate = models.CharField('Адрес доставки', max_length = 300)
